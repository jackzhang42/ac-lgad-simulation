...
```
cd existing_repo
git remote add origin https://gitlab.cern.ch/yangfan/ac-lgad-simulation.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.cern.ch/yangfan/ac-lgad-simulation/-/settings/integrations)
